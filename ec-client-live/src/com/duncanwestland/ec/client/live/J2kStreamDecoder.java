...
public class J2kStreamDecoder {
	private static J2kStreamDecoder instance;
	
	private J2kStreamDecoder() {
	}
	
	public static J2kStreamDecoder getInstance(){
		if (instance==null) instance = new J2kStreamDecoder();
		return instance;
	}

	public Image decode(InputStream is) throws EOFException, IOException,
		...
		// write out the image
		ImgStreamWriter imwriter = new ImgStreamWriter(decodedImage, 0,
				1, 2);
